    ...
    <footer className="py-8 mt-16">
      <div className="container mx-auto px-6 md:px-12 flex flex-col items-center gap-6">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="https://github.com/jaiiirot/matematica-para-la-gente/issues/new"
            className="text-black hover:text-gray-500 transition duration-300 ease-in-out flex items-center gap-2"
            target="_blank"
          >
            <svg
        ...
        <p className="text-sm text-gray-600 text-center flex gap-1">
          2024 - Matematica para la Gente by
          <a
            href="https://github.com/jaiiirot"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 hover:opacity-80 transition duration-300 ease-in-out text-gray-900"
          >
            jaiiirot
          </a>
        </p>
